    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.UUIDField(db_comment='Unique article of the product. Used for searching and identifying the product.', db_index=True, verbose_name='Product Article')),
